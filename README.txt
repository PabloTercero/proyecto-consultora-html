...
**Tipografía:** He importado la fuente **Roboto** desde Google Fonts para cumplir con el requisito del Hito 1.
...
2.  **El Menú en el móvil:** Al principio, al reducir la pantalla, el menú se rompía.He añadido una **Media Query** (`max-width: 768px`) para cambiar la dirección del flex a `column` y que se vea bien en vertical.
